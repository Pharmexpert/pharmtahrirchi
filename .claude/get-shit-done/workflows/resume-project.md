...
<required_reading>
@C:/Users/Администратор/Desktop/2/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "C:/Users/Администратор/Desktop/2/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
