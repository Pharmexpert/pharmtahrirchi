...
def generate_systematic_pairs():
    ...
    u_stems = [
        ...
        # EXPANDED: More ў-stems (50K target)
        "кўмир", "тўда", "бўлса", "кўрса", "тўхта", "ўзат",
        "бўлиб", "кўриб", "тўлиб", "ўтиб", "ўсиб", "кўчиб",
        "бўлар", "кўрар", "тўлар", "ўтар", "ўсар", "кўчар",
        "бўлмоқ", "кўрмоқ", "тўлмоқ", "ўтмоқ", "ўсмоқ",
        "кўмилмоқ", "тўкилмоқ", "бўлинмоқ", "ўрганмоқ",
        "бўлмаса", "кўрмаса", "тўлмаса", "ўтмаса",
        "бўлаётган", "кўраётган", "тўлаётган", "ўтаётган",
        "кўрсатмоқ", "тўлдирмоқ", "ўрнатмоқ", "ўзгартирмоқ",
        "бўлажаги", "кўринажаги", "тўланажаги",
        "бўйсун", "кўник", "тўғрилан", "ўзлаш",
        "кўзла", "бўғ", "тўқ", "ўрна", "кўтарил",
        "тўсат", "бўса", "кўнгилсиз", "тўкин",
        "ўзга", "кўча", "бўрк", "тўнғиз",
        "кўклам", "тўрва", "бўйдоқ", "ўғил",
        "кўзнак", "тўқнаш", "бўйсундир", "ўрнатувчи",
    ]
    for stem in u_stems:
